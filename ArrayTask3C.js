function calculateTotalSales(dailySales) {
  ...
  console.log("Average Daily Sales:", calculateAverageDailySales(sampleSalesData));
  console.log("Best Selling Day(s):", findBestSellingDay(sampleSalesData));

  const anotherSalesData = [90, 120, 150, 80, 200, 180, 210];
  
  console.log("Total Sales:", calculateTotalSales(anotherSalesData));
  console.log("Average Daily Sales:", calculateAverageDailySales(anotherSalesData));
  console.log("Best Selling Day(s):", findBestSellingDay(anotherSalesData));